...
ALTER TABLE parser_alt_token 
	DROP constraint parser_alt_token_uk1
/
...
COMMENT ON COLUMN parser_alt_token.source IS 'indicate the source of the grammar rules. For example a rhs with repetition may haven been transform to alternates
